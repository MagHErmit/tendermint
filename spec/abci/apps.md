...
[default in-process ABCI client](https://github.com/MagHErmit/tendermint/blob/v0.34.4/abci/client/local_client.go#L18)
and the
[default Go ABCI
server](https://github.com/MagHErmit/tendermint/blob/v0.34.4/abci/server/socket_server.go#L32)
...
proposal. See [#1861](https://github.com/MagHErmit/tendermint/issues/1861).
