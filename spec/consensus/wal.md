...
Make sure to read about [WAL corruption](https://github.com/MagHErmit/tendermint/blob/v0.34.x/docs/tendermint-core/running-in-production.md#wal-corruption)
