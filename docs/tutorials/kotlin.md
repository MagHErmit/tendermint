...
file](https://github.com/MagHErmit/tendermint/blob/v0.34.x/proto/tendermint/abci/types.proto).
...
```bash
mkdir -p \
  $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/abci \
  $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/version \
  $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/types \
  $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/crypto \
  $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/libs \
  $KVSTORE_HOME/src/main/proto/github.com/gogo/protobuf/gogoproto

cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/abci/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/abci/types.proto
cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/version/version.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/version/version.proto
cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/types/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/types/types.proto
cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/types/evidence.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/types/evidence.proto
cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/types/params.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/types/params.proto
cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/crypto/merkle.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/crypto/merkle.proto
cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/crypto/keys.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/crypto/keys.proto
cp $GOPATH/src/github.com/MagHErmit/tendermint/proto/tendermint/libs/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/MagHErmit/tendermint/proto/tendermint/libs/types.proto
...
specification"](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/abci/apps.md#gas).
...
package](https://godoc.org/github.com/MagHErmit/tendermint/light)) can leverage
...
[here](https://github.com/MagHErmit/tendermint/tree/v0.34.x/spec/abci/).
...
```bash
rm -rf /tmp/example
cd $GOPATH/src/github.com/MagHErmit/tendermint
make install
...
Github](https://github.com/MagHErmit/tendermint/issues/new/choose). To dig
