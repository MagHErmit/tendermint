...
definition](https://github.com/MagHErmit/tendermint/blob/v0.34.x/types/genesis.go)).
...
- `consensus_params` [spec](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/core/data_structures.md#consensusparams)
    - `block`
...
See the
[UPGRADING.md](https://github.com/MagHErmit/tendermint/blob/v0.34.x/UPGRADING.md)
