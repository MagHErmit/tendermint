...
[List of events](https://godoc.org/github.com/MagHErmit/tendermint/types#pkg-constants)
...
section](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/abci/abci.md#endblock) in
the ABCI spec).
