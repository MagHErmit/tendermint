...
(ABCI)](https://github.com/MagHErmit/tendermint/tree/v0.34.x/abci)
...
[Tendermint Core](https://github.com/MagHErmit/tendermint) (the
...
specification](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/abci/abci.md).
