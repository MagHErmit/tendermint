...
import (
	...
	"github.com/MagHErmit/tendermint/light/provider"
	rpcclient "github.com/MagHErmit/tendermint/rpc/client"
	rpchttp "github.com/MagHErmit/tendermint/rpc/client/http"
	"github.com/MagHErmit/tendermint/types"
)

var (
	// This is very brittle, see: https://github.com/MagHErmit/tendermint/issues/4740
