...
import (
	...
	cryptoenc "github.com/MagHErmit/tendermint/crypto/encoding"
	"github.com/MagHErmit/tendermint/libs/async"
	"github.com/MagHErmit/tendermint/libs/protoio"
	tmsync "github.com/MagHErmit/tendermint/libs/sync"
	tmp2p "github.com/MagHErmit/tendermint/proto/tendermint/p2p"
)
...
// See https://github.com/MagHErmit/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/MagHErmit/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/MagHErmit/tendermint/issues/3531
