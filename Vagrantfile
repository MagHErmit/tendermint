...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/MagHErmit/tendermint' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/tendermint
    ln -s /vagrant /home/vagrant/go/src/github.com/MagHErmit/tendermint
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/MagHErmit/tendermint && make tools'
  SHELL
end
