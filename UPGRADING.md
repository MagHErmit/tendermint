...
Refactor](https://github.com/MagHErmit/tendermint/blob/main/docs/architecture/adr-067-mempool-refactor.md).
...
* New ABCI methods (`ListSnapshots`, `LoadSnapshotChunk`, `OfferSnapshot`, and `ApplySnapshotChunk`)
  ...
  Read [the spec](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/abci/apps.md#state-sync)
...
* The [`PublicKey` type](https://github.com/MagHErmit/tendermint/blob/v0.34.x/proto/tendermint/crypto/keys.proto#L13-L15)
...
For more on the Protobuf changes, please see our [blog post on this migration](https://medium.com/MagHErmit/tendermint-0-34-protocol-buffers-and-you-8c40558939ae).
...
* The `state` package now has a `Store` interface. All functions in
  [state/store.go](https://github.com/MagHErmit/tendermint/blob/56911ee35298191c95ef1c7d3d5ec508237aaff4/state/store.go#L42-L42)
...
```sh
go install -mod=readonly -ldflags "-X github.com/MagHErmit/tendermint/version.TMCoreSemVer=$(go list -m github.com/MagHErmit/tendermint | sed  's/ /\@/g') -s -w " -trimpath ./cmd
```
...
[here](https://github.com/MagHErmit/tendermint/pull/3668).
...
keys are called
[compositeKeys](https://github.com/MagHErmit/tendermint/blob/6d05c531f7efef6f0619155cf10ae8557dd7832f/docs/app-dev/indexing-transactions.md).
...
For further documentation on `Events`, see the [docs](https://github.com/MagHErmit/tendermint/blob/60827f75623b92eff132dc0eff5b49d2025c591e/docs/spec/abci/abci.md#events).
...
* [Merkle tree](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/blockchain/encoding.md#merkle-trees)
* [ConsensusParams](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/blockchain/state.md#consensusparams)

There was also a small change to field ordering in the vote struct. Any
implementations of an out-of-process validator (like a Key-Management Server)
will need to be updated. For specific details:

* [Vote](https://github.com/MagHErmit/tendermint/blob/v0.34.x/spec/consensus/signing.md#votes)

Finally, the proposer selection algorithm continues to evolve. See the
[work-in-progress
specification](https://github.com/MagHErmit/tendermint/pull/3140).
...
See [#3105](https://github.com/MagHErmit/tendermint/issues/3105).
Note the Unix socket has neither encryption nor authentication, but will
add a shared-secret in [#3099](https://github.com/MagHErmit/tendermint/issues/3099).
...
* [ADR-026](https://github.com/MagHErmit/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/architecture/adr-026-general-merkle-proof.md)
* [Relevant ABCI
  documentation](https://github.com/MagHErmit/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/spec/abci/apps.md#query-proofs)
* [Description of
  keys](https://github.com/MagHErmit/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/crypto/merkle/proof_key_path.go#L14)
...
[here](https://github.com/MagHErmit/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/cmd/tendermint/commands/run_node.go#L60).
